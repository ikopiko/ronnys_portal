export const menuItems = [
    ...
    },
    {
        ...
        role: ["financialManager", "operationalManager", "branchManager", "marketingManager", "hrManager", "admin"],
    },
    {
        id: 9,
...

    {
        ...
        icon: "bxs-bank",
        link: "/reports/banks",
        role: ["financialManager", "operationalManager", "branchManager", "hrManager", "admin"],
    },
    {
        id: 11,
        label: "Sales report",
    ...
    },
    {
        ...
        icon: "bx-user",
        link: "/users",
        role: ["operationalManager", "branchManager", "hrManager", "admin"],
    },
    { 
        id: 16,
    ...
    },
    {
        ...
        role: ["financialManager", "operationalManager", "branchManager", "inventoryManager", "hrManager", "admin"],
    },
    {
        id: 18,
        ...
        role: ["financialManager", "operationalManager", "branchManager", "inventoryManager", "hrManager", "admin", "procurement"],
    },
    {
        id: 19,
