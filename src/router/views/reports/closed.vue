            ...
            let excelExportProperties = {
                header: {
                    ...
                    rows: [
                        ...
                        { cells: [{ colSpan: 4, value: "Closed", style: { fontColor: '#000000', fontSize: 15, hAlign: 'Center', bold: true, } }] },
                    ...
                    <div id="app">
                      ...
                      <ejs-grid ref='Grid' id='Grid' :dataSource='exportData'  :toolbar='toolbarOptions' height='270px' :allowPaging='true' :allowExcelExport='true' :toolbarClick='toolbarClick'>
                          <e-columns>
                              ...
                              <e-column field="name" headerText="username"></e-column>
                              <e-column field="posName" headerText="POS"></e-column>
                              <e-column field="driver" headerText="driver"></e-column>
                              <e-column field="diff_cash" headerText="Difference Cash" ></e-column>
                              <e-column field="diff_card" headerText="Difference Card" ></e-column>
