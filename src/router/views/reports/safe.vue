    ...
    //     }
      ...
      axios
        .request({
          method: "post",
          url:
            this.branchURL + "poses/safe-detail",
          headers: {
            Authorization: "Bearer " + TOKEN,
          },
          data: bodyUpdate,
        ...
        .then((response) => {
            ...
            excelObject.id = x.id;
            excelObject.name = x.user_name;
            excelObject.posName = x.pos_name;
            excelObject.driver = x.driver_name;
            excelObject.amount = x.amount;
            excelObject.pos_id = x.pos_id;
            excelObject.action = x.payment;
            excelObject.comment = x.comment;
                    ...
                    <div id="app">
                      ...
                      <ejs-grid ref='Grid' id='Grid' :dataSource='exportData'  :toolbar='toolbarOptions' height='270px' :allowPaging='true' :allowExcelExport='true' :toolbarClick='toolbarClick'>
                          <e-columns>
                              ...
                              <e-column field="name" headerText="User Name"></e-column>
